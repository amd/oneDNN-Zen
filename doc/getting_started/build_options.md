...
linearly ordered as `AVX2` < `AVX512`. When specified, selected ISA and all
ISA that are "smaller" will be available. Example that leaves AVX2 kernels
but removes AVX512 and AMX kernels:
```
